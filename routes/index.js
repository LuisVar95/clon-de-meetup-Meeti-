...
const meetiControllerFE = require('../controllers/fontend/meetiControllerFE');
const usuariosControllerFE = require('../controllers/fontend/usuariosControllerFE');
const gruposControllerFE = require('../controllers/fontend/gruposControllerFE');
const comentariosControllerFE = require('../controllers/fontend/comentariosControllerFE');
const busquedaControllerFE = require('../controllers/fontend/busquedaControllerFE');
...
module.exports = function(){
    ...
    router.post('/nuevo-grupo', authController.usuarioAutenticado, gruposController.subirImagen, [
